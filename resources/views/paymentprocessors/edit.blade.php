        ...
        <div class="create-form">
            <form method="POST" action="{{ route('payment_processors.update', $paymentprocessor->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group row"> 
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $paymentprocessor->name }}" required autocomplete="name" autofocus disabled>
