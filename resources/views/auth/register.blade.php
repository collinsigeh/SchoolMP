...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register a School') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <input type="hidden" name="pic" value="default_userimage.png" />
                        
                        <div class="form-group row">
                            <div class="col-md-8 offset-md-2">
                                <input id="school" type="text" class="form-control @error('school') is-invalid @enderror" name="school" value="{{ old('school') }}" required autocomplete="school" placeholder="Name of school" autofocus>
