                            ...
                            <table class="table table-striped table-hover table-sm">
                                ...
                                @else
                                    @foreach ($enrolment->results as $result_slip)
                                        <tr>
                                            <td>
                                                <a class="collins-link-within-table" href="#"><img src="{{ config('app.url') }}/images/icons/subjects_icon.png" alt="subject_icon" class="collins-table-item-icon">  {{ $result_slip->classsubject->subject->name }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
                      ...
                      <div class="table-responsive">    
                        <table class="table">
                            ...
                            <tr>
                              <td>
                                <button class="btn btn-sm btn-block btn-outline-primary text-left"  data-toggle="modal" data-target="#feesBreakdownModal">
                                  <img src="{{ config('app.url') }}/images/icons/voucher_icon.png" alt="payment_icon" class="options-icon">  Online payment
                                </button>
                              </td>
                            </tr>
                            <tr>
                              <td>
                                <button class="btn btn-sm btn-block btn-outline-primary text-left"  data-toggle="modal" data-target="#feesBreakdownModal">
                                  <img src="{{ config('app.url') }}/images/icons/paymentprocessor_icon.png" alt="fees_icon" class="options-icon">  Payment history
                                </button>
                              </td>
                            </tr>
                            <tr>
