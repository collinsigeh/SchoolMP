		...
		<div id="GFG" style="width: 900px;"> 
			...
			<div style="border: 3px solid #666; padding: 20px;  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
				...
				<div style="text-align: center;">
					...
					?>
					<table cellspacing="0" style="margin-top: 15px; border:1px solid #d3d3d3; text-align: left; font-size: 0.9em;">
						<tr style="vertical-align: middle;">
							<th width="20px" style="border:1px solid #d3d3d3; padding: 3px; background-color: #e2e2e2; font-size: 0.9em; font-weight: 600;">
								#
							</th>
							<th width="315px" style="border:1px solid #d3d3d3; padding: 3px; background-color: #e2e2e2; font-size: 0.9em; font-weight: 600;">
								Subject
							</th>
							<th width="104px" style="border:1px solid #d3d3d3; padding: 3px; background-color: #e2e2e2; font-size: 0.9em; font-weight: 600; text-align: center;">
								C.A. (%)<br />
								{{ $ca }}
							</th>
							<th width="104px" style="border:1px solid #d3d3d3; padding: 3px; background-color: #e2e2e2; font-size: 0.9em; font-weight: 600; text-align: center;">
							...
							<th width="198px" style="border:1px solid #d3d3d3; padding: 3px; background-color: #e2e2e2; font-size: 0.9em; font-weight: 600; text-align: center;">
								Remark
							</th>
						</tr>
						<?php
						...
						<tr style="vertical-align: middle;">
							...
							<td style="border:1px solid #d3d3d3; padding: 3px;">{{ $result_slip->classsubject->subject->name }}</td>
