...
<div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-10 main">
        <div class="row">
          <div class="col-8">
          <h3>{!! $classsubject->subject->name.' (<i>New CBT - 2nd Test</i>)' !!}</h3>
          </div>
        ...
        <div class="pagenav">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">New CBT - 2nd Test</li>
            </ol>
          </nav>
        ...
        <div class="welcome">
            ...
            <div class="row">
                <div class="col-md-6 offset-md-4">
                    <div class="alert alert-info">Complete the form below to add a new CBT - 2nd Test.</div>
                </div>
            </div>
            ...
            <div class="create-form">
                <form method="POST" action="{{ route('cbts.store') }}">
                    ...
                    <input type="hidden" name="type" value="2nd Test">
