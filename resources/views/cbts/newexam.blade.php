            ...
            <div class="create-form">
                <form method="POST" action="{{ route('cbts.store') }}">
                    ...
                    <div class="form-group row"> 
                        ...
                        <div class="col-md-6">
                            <input id="supervisor_password" type="text" class="form-control @error('supervisor_password') is-invalid @enderror" name="supervisor_password" value="{{ old('supervisor_password') }}" required autocomplete="supervisor_password" autofocus>
